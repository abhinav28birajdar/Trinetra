  ...
  const handleRegister = async () => {
    ...
    if (signUpError) {
      Alert.alert('Registration Failed', signUpError.message);
        ...
        // Optionally update the profile immediately after signup confirmation
         try {
             ...
             if (profileError) {
                 console.warn("Could not update profile post-signup:", profileError.message);
             }
         } catch (e) {
              console.warn("Error updating profile post-signup:", e);
         }
